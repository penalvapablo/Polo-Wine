  ...
  return (
    <section className={styles.presentacion}>
      <div className={styles.mobileDiv1}>
        <div className={styles.desktopDiv}>
          {language === 'es' && <>
            ...
            <p className={styles.text}>Argentina es reconocida en todo el mundo por la calidad de sus vinos y por tener el mejor equipo de polo de la historia.<br /><br />En Polo & Wines unimos ambas pasiones para ofrecerte una experiencia 100% nacional, diseñada por un <span>equipo de profesionales que conocen cada destino de primera mano y que te ayudarán a organizar tu viaje de manera inteligente.</span></p></>
          }
          {
            language === 'en' &&
            <>
      ...
      <div className={styles.mobileDiv2}>
        <h2 className={`${styles.title1} ${styles.title2}`}>Hablamos tu mismo idioma</h2>
