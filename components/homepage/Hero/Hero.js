...
const Hero = ({ languageObj }) => {
  ...
  let { language, languageFnEs, languageFnEn } =
    languageObj;
  const mobileNavFn = () => {
    ...
    <header
      ...
      <div className={styles.languageBtns}>
        <button
          ...
          onClick={languageFnEs}>
          ES
        </button>
        <p>/</p>
        <button
          className={styles.languageBtn}
          onClick={languageFnEn}>
          EN
        </button>
      </div>
        ...
        <>
          <div className={styles.textContainer}>
            ...
            <p className={styles.text}>
              Combinamos tu pasión por el deporte, la música
              y el entretenimiento con los mejores destinos.
            </p>
            <p className={styles.text}>
        ...
        <>
          <div className={styles.textContainer}>
            ...
            <p className={styles.text}>
              ...
              <span>
                without missing out on the tourist details
                of each city.
              </span>
            </p>
            <Link
